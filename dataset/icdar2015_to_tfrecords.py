...
if __name__ == "__main__":
    root_dir = util.io.get_absolute_path(config.data_row_dir)
    output_dir = util.io.get_absolute_path(config.data_dir)
    util.io.mkdir(output_dir)

    training_data_dir = util.io.join_path(root_dir, config.train_data)
    training_gt_dir = util.io.join_path(root_dir,config.train_gt)
    cvt_to_tfrecords(output_path = util.io.join_path(output_dir, config.train_trrecords), data_path = training_data_dir, gt_path = training_gt_dir)
